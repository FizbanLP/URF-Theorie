...
Abweichung zu Planck 2018: **1.4 %**.

---

## Kurzübersicht

Das URF-Feld Phi ist ein skalares Kohärenzfeld, das durch baryonische Materie
angetrieben wird und gravitativ wirkt – ohne selbst ein Teilchen zu sein.

| Merkmal              | URF                              |
|----------------------|----------------------------------|
| Neue Teilchen        | Keine                            |
| Freie Parameter      | 1 (Sigma_sat)                    |
...
5. **Kosmologische Relation** – eta^2 = 1 - sqrt(Omega_b/Omega_m), Abw. 1.4 %
...
Du darfst diese Arbeit teilen und bearbeiten, solange du den Autor nennst.
